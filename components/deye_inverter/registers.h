...
constexpr uint16_t SETTINGS2_LEN = 110;
    ...
    constexpr uint16_t REG_TOTAL_GRID_IMPORT = 522;             // Alias: Gesamt Netzbezug (Import)
    ...
    constexpr uint16_t REG_TOTAL_GRID_EXPORT = 524;             // Alias: Gesamt Netzeinspeisung (Export)
